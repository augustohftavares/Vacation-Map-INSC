...
namespace INSCmapaFerias.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        [Display(Name ="Introduza o seu novo endereço de email aqui")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.PhoneNumber != phoneNumber)
            {
                ...
                {
                    StatusMessage = "Erro ao tentar alterar o número de telefone";
            ...
            if(Input.UserName != userName)
            {
                ...
                {
                    StatusMessage = "Erro ao tentar alterar o utizador/email";
            ...
            StatusMessage = "O teu perfil foi alterado com sucesso";
            return RedirectToPage();
